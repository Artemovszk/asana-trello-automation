...
## 📌 Projekt leírás
Ez a projekt automatikusan hoz létre Trello kártyákat Python segítségével a Trello API-n keresztül.

A megoldás ideális:
- adminisztratív feladatok automatizálására
- projektindítás gyorsítására
